...
urlpatterns = [
    ...
    path('proyect/retrive/<int:pk>/', V_proyect_retrive.as_view()),
    ...
    path('proyect_comentary/retrive/<int:pk>/', V_proyect_comentary_retrive.as_view()),
    ...
    path('attach_proyect/retrive/<int:pk>/', V_attach_proyect_retrive.as_view()),
